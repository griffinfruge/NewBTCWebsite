		...
		<div class="row">
			<div class="sd-event-shortcode">
					...
					<div class="col-md-6">
						<div class="sd-event-upcoming">
							...
							<div class="sd-event-data">
								<span class="sd-dov"><?php echo gmdate( get_option( 'date_format' ), $dov ); ?> <?php echo _x( 'at', 'refering to time', 'sd-framework' ); ?> <?php echo gmdate( get_option( 'time_format' ), $dov ); ?></span>
				...
				<?php endif; ?>
					...
					<div class="col-md-6 sd-later-events">
						<?php if ( has_post_thumbnail() ) : ?>
							<div class="sd-event-thumb">
								<figure>
						...
						<?php endif; ?>
						<div class="sd-event-data">
							<span class="sd-dov"><?php echo gmdate( get_option( 'date_format' ), $dov ); ?></span>
							<span class="sd-event-city"><?php echo $sd_ev_city; ?></span>
						</div>
						<!-- sd-event-data -->
						<h3><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a></h3>
