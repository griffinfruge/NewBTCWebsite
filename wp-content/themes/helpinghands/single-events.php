...
if ( !empty( $header_bg ) ) {
	$styling[] = 'background: url(' . $header_bg[0] . ') ' . $bg_repeat . $repeat_x . $repeat_y . ';';
}
...
<?php if ( $show_title == '1' ) : ?>
	<div class="sd-page-top-bg" <?php echo $styling; ?>>
		<div class="container">
			<div>
				<h2><?php if ( ! empty( $custom_title) ) echo $custom_title; else the_title(); ?></h2>
			</div>
							...
							<div class="col-md-3 col-sm-3 sd-padding-left-none">
								<div class="sd-event-data">
									<span class="sd-dov">
										...
										<?php echo gmdate( get_option( 'date_format' ), $dov ); ?> <?php echo _x( 'at', 'refering to time', 'sd-framework' ); ?> <?php echo gmdate( get_option( 'time_format' ), $dov ); ?>
									</span>
