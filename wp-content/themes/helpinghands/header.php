...
$header_email    = isset( $sd_data['sd_header_email'] ) ? $sd_data['sd_header_email'] : NULL;
						...
						<?php if ( ! empty( $header_email ) ) : ?>
							<div class="sd-header-extra-email clearfix">
								...
								<span>
									...
									<a href="mailto:<?php echo $header_email; ?>" title="<?php _e( 'Email Us', 'sd-framework' ); ?>"><?php echo $header_email; ?></a>
								</span>
							</div>
